...
%  Abre la imagen de forma morfol�gica.
...
% Sustrae el fondo de la imagen original para obtener un fondo m�s uniforme
% pero un poco oscuro para su an�lisis 
I2 = I - background;
imshow(I2)
title('Background')
%%
%Imadjust incrementa el contraste de la imagen procesada I2 
